...
BASE_TEMPLATE_URL=https://raw.githubusercontent.com/Marklaps/Moodle-auze/master/$CURRENT_BRANCH/nested/
echo "Base template URL: $BASE_TEMPLATE_URL"

SCRIPT_LOCATION=https://raw.githubusercontent.com/Marklaps/Moodle-auze/master/$CURRENT_BRANCH/scripts/
echo "Script location: $SCRIPT_LOCATION"

DEPLOY_TO_AZURE_URL=https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FMarklaps%2FMoodle-auze%2F$CURRENT_BRANCH%2Fazuredeploy.json
