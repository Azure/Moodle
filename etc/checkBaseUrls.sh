...
SCRIPT_LOCATION=https://raw.githubusercontent.com/Azure/Moodle/master/scripts/
...
VISUALIZE_URL=http://armviz.io/#/?load=https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2F$CURRENT_BRANCH%2Fmaster%2Fazuredeploy.json
