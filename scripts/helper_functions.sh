...
# Long fail2ban config file generation code moved here.
function create_fail2ban_configuration
{
...
# Long nginx config file generation code moved here
function create_nginx_configuration
{
...
# Long Varnish configuration file generation code moved here
function create_varnish_configuration
{
